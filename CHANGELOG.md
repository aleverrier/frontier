...
- Added academic metadata, reproducibility, provenance, contribution, release,
  and checksum-manifest documentation for public research-software use.

## 0.1.0 - 2026-06-18

- Initial public frontier export.
- C++ native frontier engine.
