...
The remaining improvements are to count only parity-compatible visible
families, control their actual ordering lifetimes, exploit (15) at finite
size, and analyze terminal logical ranking through charged/projective sector
distortion.  None of the present bounds equates raw frontier width with
logical error.
