...
- Added README matrix-availability notes: static matrix files are not checked in; in-repo constructors cover surface-code checks and generated rotated-surface DEMs, while the accepted Gross split-sector DEM builder needs optional public Gross-code matrix/circuit assets.
