...
_GLOBAL_PRODUCTION_MODE: bool = False
            ...
            try:
                decode_kwargs: dict[str, object] = {
                    ...
                    "log_mass_primary_production_path": (
                        "guarded" if bool(_GLOBAL_PRODUCTION_MODE) else "off"
                    ),
...
def _parse_args() -> argparse.Namespace:
    ...
    plot_group.add_argument(
        ...
        dest="write_plots",
        action="store_true",
        help="Write report plots even when --production-mode is set.",
    )
    plot_group.add_argument(
        "--no-write-plots",
        dest="write_plots",
    ...
    report_group.add_argument(
        ...
        dest="write_report",
        action="store_true",
        help="Write report.md even when --production-mode is set.",
    )
    report_group.add_argument(
        "--no-write-report",
        dest="write_report",
    ...
    if args.export_terminal_selector_signals is None:
        args.export_terminal_selector_signals = not bool(args.production_mode)
    if args.write_plots is None:
        args.write_plots = not bool(args.production_mode)
    if args.write_report is None:
        args.write_report = not bool(args.production_mode)
...
def main() -> None:
    ...
    _GLOBAL_PRODUCTION_MODE = bool(args.production_mode)
    _GLOBAL_FRONTIER_PRESSURE_TRACE_ROWS = []
